...
custom_syscall/revstr.o: $(deps_custom_syscall/revstr.o)

$(deps_custom_syscall/revstr.o):

custom_syscall/revstr.o: $(wildcard ./tools/objtool/objtool)
